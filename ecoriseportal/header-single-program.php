...
<html <?php language_attributes(); ?>>
    ...
    <?php $program_id = get_post(get_the_ID());
        if($program_id && $program_id != 0){
            ...
            $logo_src = get_post_meta($service_provider_id, 'wpcf-organization_logo', true);
        }
    ?>
    <body itemscope="" itemtype="http://schema.org/WebPage" class="<?php echo implode(' ', get_body_class()); ?>">
        ...
        <div class="bg-white container shadow-lg site">
            ...
            <header id="jr-header" class="hasFeature singleProgram" style="<?php if($image_attributes) echo 'background-image:url(\''.$image_attributes[0].'\')' ?>">
