            ...
            <div id="main-content">
                <div>
                    ...
                    <nav class="container navigation post-navigation pt-3 pb-3">
                        ...
                        <div class="row nav-links justify-content-between"><span class="nav-previous"><?php previous_post_link( '%link', __( '&laquo; %title', 'tb_theme' ) ); ?></span><span class="nav-next"><?php next_post_link( '%link', __( '%title &raquo;', 'tb_theme' ) ); ?></span>
                        </div>
                        <!-- .nav-links -->
                    </nav>
