...
class GFL_Update_Posts {
	...
	public function init() {
		...
		if ( ! empty( $this->_args['form_id'] ) ) {
			...
			add_action( 'gravityflow_step_complete', 'update_post_by_entry', 10, 4 );
	...
	public function update_post_by_entry( $step_id, $entry_id, $form_id, $status ) {
