...
if ( ! function_exists( 'tb_theme_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'tb_theme-bootstrap', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', array( 'jquery' ), null, true );
    ...
    wp_enqueue_script( 'jr_custom_js', get_template_directory_uri() . '/a_js/custom.js', array( 'anamate_green' ), null, true );
...
function tb_theme_blocks_init() {
    ...
    require_once 'blocks/plaincard/plaincard_register.php';
...
$categories = array_merge( $categories, array( array(
        'slug' => 'custblocks',
        'title' => __( 'Custom Theme Blocks', 'tb_theme' )
    ) ) );
